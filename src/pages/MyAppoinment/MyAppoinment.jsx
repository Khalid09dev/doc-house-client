...
const MyAppoinment = () => {
    return (
        <div>
            ...
            {/* dashboard sidebar */}
            <div className='fixed bg-[#FFFFFF]  top-0 bottom-0 left-0 mt-[70px]'>
                <ul>
            ...
            {/* dashboard content */}
            <div className='flex-1 pt-20 pl-52 min-h-screen bg-[#F1F5F9]'>
                ...
                <table className='mt-6'>
                    <thead>
                        <tr className='text-[#000000] py-3 rounded-t-lg text-base font-bold bg-[#E6E6E6] flex mx-36 gap-52'>
                            <th></th>
                            <th>Name</th>
                            <th>Service</th>
                    ...
                    <tbody>
                    <tr className='flex border text-[#000000] text-base font-normal items-center mx-36 px-6 gap-40 bg-white py-3'>
                        <th>1</th>
                        <td>John Doe</td>

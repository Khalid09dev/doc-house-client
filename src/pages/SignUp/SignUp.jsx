    ...
    return (
        <div className='md:flex grid md:h-screen'>
            ...
            <div className='md:flex justify-center items-center md:w-1/2'>
                <form onSubmit={handleSignup} className='border md:p-[50px] p-[30px] rounded-lg'>
                    <h3 className='text-[#0A0808] text-[20px] font-bold md:pb-8 pb-4 text-center md:px-14'>Sign Up to Doc House</h3>

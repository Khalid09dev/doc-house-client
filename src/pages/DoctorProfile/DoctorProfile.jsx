...
const DoctorProfile = () => {
    ...
    return (
            ...
            <div className="md:flex grid justify-center md:ml-[300px] ml-5 mr-5 md:mr-32 md:pr-44 py-8 rounded-lg bg-white md:gap-7 gap-3">
                ...
                <div>
                    ...
                    <div className="md:flex grid grid-cols-3 gap-3">
                        ...
                        <img className="bg-[#F3F3F3] w-[60px] rounded-lg h-[60px]" src="" alt="" />
                        <img className="bg-[#F3F3F3] w-[60px] rounded-lg h-[60px]" src="" alt="" />
                        <img className="bg-[#F3F3F3] w-[60px] rounded-lg h-[60px] md:hidden block" src="" alt="" />
                    </div>
        ...
        <div className="container md:block hidden mx-auto p-8 rounded-lg bg-white mt-20 border">
            ...
            {/* mobile device */}
        <div className="container md:hidden block mx-auto p-8 rounded-lg bg-white mt-20 border">
            <div role="tablist" className="tabs flex items-center ">
                <button
                    role="tab"
